...
def plot_deviations_bar_mean(mean_dev):
    ...
    #mean_dev[['CosinePlofA_CosineRel', "WordnetPlofA_SinglerankRel", 'WordnetPlofA_CosineRel', 'CosinePlofA_SinglerankRel', "CosineSim_Singlerank_meanedRel", "WordnetSim_Singlerank_meanedRel", 'ExpertExpDem', 'MeanExpDem']].plot(kind='bar', colormap="Set2", legend=False)
    plt.xlabel('method')
...
def plot_deviations_bar_expert(expert_dev):
    ...
    expert_dev[['CosinePlofA_CosineRel', "WordnetPlofA_SinglerankRel", 'WordnetPlofA_CosineRel', 'CosinePlofA_SinglerankRel', "CosineSim_Singlerank_meanedRel", "WordnetSim_Singlerank_meanedRel", 'MeanExpDem']].plot(kind='bar', colormap="Set2", legend =False)
    plt.xlabel('method')
